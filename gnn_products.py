...
from utils import sparse_mx_to_torch_sparse_tensor, T_summer, graph_srw_transition_matrix, normalize, degree_normalize_adj, normalize_adj
import numpy as np
import torch
...
def main():
    ...
    # torch.save(data, 'ogbn-products-data-gdc.pt')
    # data = torch.load('ogbn-products-data-gdc.pt')
    ############################################
    ...
    # data.x = SparseTensor.eye(2449029, 2449029)
    ...
    # torch.save(data, 'ogbn-products_{}_{}.pt'.format(args.hidden_channels, args.model))
